      ...
      <div className="row container mx-auto">
        <div className="col-lg-6 col-md-6 col-12">
          <div className="container text-center border my-4 py-4">
            ...
            <div className="text-uppercase mt-3">
              <h1>
                Hi <span className="text-danger">!</span>
              </h1>
        ...
        <div className="col-lg-6 col-md-6 col-12">
          <div className="mt-4">
            <img
              className="img-fluid"
              src={`https://i.ibb.co/BfjC507/24-hour-customer-service-to-help-users-solve-problems-Chatting-service-helps-question-with-technical.jpg`}
              alt=""
            />
          </div>
        </div>
